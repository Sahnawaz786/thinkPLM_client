        ...
        <div className={classes.container}>
          <p className={classes.container_paragraph}>
            <div className={styles.logoText} style={{ marginBottom: "10px" }}>
              ...
              />
              Document-{supplierInformation?.document_name},
              {iteration_info || id}
            </div>
          </p>
        </div>
        ...
        <div>
          <div className={classes.tab_nav}>
            <div className={classes.tab_buttons}>
              <button
                className={
                  activeBtn === "supplier-document-details" ||
                  activeBtn == "document-historyInfo"
                    ? styleBtn.activeBtn
                    : ""
                }
              ...
              <button
                className={
                  activeBtn === "document-history" ? styleBtn.activeBtn : ""
                }
                onClick={() => referenceObjectHandler()}
              >
                History
              </button>
              <button
                className={activeBtn === "attachment" ? styleBtn.activeBtn : ""}
