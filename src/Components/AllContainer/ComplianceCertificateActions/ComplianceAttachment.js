...
const { getComplianceDocumentById,getFileDownload } = new ComplianceServices();

const ComplianceAttachment = ({ id }) => {
  ...
  const getSupplier = async (id) => {
    ...
    const supplierInfo = await getComplianceDocumentById(id);
