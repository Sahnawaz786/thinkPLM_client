...
const VendorForm = () => {
  ...
  const handleFileUpload = (event) => {
    ...
    const submitHandler = async(event)=>{
      ...
      const { category,name,email,contact,pt,country,state,district,location,start_date,end_date,document}=userData;


    try{
     // `http://localhost:8181/addsuppliers`
     //https://kkh-mech-default-rtdb.firebaseio.com/vendor.json
  ...
  <>
      ...
      <div className={classes.container}>
          <form className={classes.form} onSubmit={submitHandler}>
           <h3>Vendor Entry</h3>
           <h4>Autogenerated Id(V00001)</h4>
            <div className={classes.content}>
            <div className={classes.input}>
              <label>Supplier Category*</label>
              <input type='text' name="category"  value={userData.category} onChange={postUserData} />
              {/* <select 
            ...
            <div className={classes.input}>
              <label htmlFor='text'>Vendor Name*</label>
              <input type='text' id='name' name="name"  value={userData.name} onChange={postUserData} />
            </div>

            <div className={classes.input}>
              <label htmlFor='text'>Email ID*</label>
              <input type='text' id='email' name="email"  value={userData.email} onChange={postUserData} />
            </div>
            ...
            <div className={classes.input}>
              <label htmlFor='text'>Product Type*</label>
              <input type='text' id='pt' name="pt" value={userData.pt} onChange={postUserData}/>
            </div>
            ...
            <div className={classes.input}>
              ...
              <input type='text' id='district' name="district"  value={userData.district} onChange={postUserData}/>
            </div>

            <div className={classes.input}>
              <label htmlFor='text'>Location/Address*</label>
              <input type='text' id='location' name="location"  value={userData.location} onChange={postUserData}/>
            </div>

            <div className={classes.input}>
                  <label htmlFor='text'>Contract Start Date*</label>
                  <input type='date' id='sdate' name="start_date"  value={userData.start_date} onChange={postUserData}/>
                </div>
                <div className={classes.input}>
                  <label htmlFor='text'>Contract End Date*</label>
                  <input type='date' id='location' name="end_date"  value={userData.end_date} onChange={postUserData}/>
                </div>
                <div className={classes.input}>
                  <label htmlFor='document'>Upload Contract Document*</label>
                  <input type='file' className={classes.fileUpload} id='document' name="document" onChange={handleFileUpload}/>
                </div>
